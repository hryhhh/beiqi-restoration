...
import { List, Tag, Button, Popconfirm, Select, InputNumber, Empty, Spin } from 'antd';
...
export default function AnnotationPanel({
  annotations, loading, selectedId, onSelect, onUpdate, onDelete,
}: Props) {
